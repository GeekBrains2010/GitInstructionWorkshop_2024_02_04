...
Visual Studio Code — это упрощенный редактор, который работает в Windows, Linux и Mac. Она включает интеграцию Git и поддержку расширений. Скачайте и установите Visual Studio Code для операционной системы
